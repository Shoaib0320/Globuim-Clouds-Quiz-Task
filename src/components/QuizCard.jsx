  ...
  return (
    <div className="w-full max-w-2xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
      ...
      <div className="p-8">
        ...
        {/* Question Text */}
        <h3 className="text-lg text-gray-800 mb-8 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          {(options || ['Chance', 'Water Works', 'Electric Company', 'Community Chest']).map((option, index) => (
            <button
              key={index}
        ...
        <div className="flex justify-between items-center mb-2">
          <span className="text-sm text-gray-600">Score: {score || 69}%</span>
          <span className="text-sm text-gray-600">Max Score: {maxScore || 75}%</span>
        </div>
